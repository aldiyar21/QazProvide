...
const Header = ({ activeHeading }) => {
  ...
  const isShoppingRestricted = isSeller || isAdmin;
      ...
      >
        ...
        >
          ...
          <div className="flex">
            ...
            {!isShoppingRestricted && openCart && <Cart setOpenCart={setOpenCart} />}
            {!isShoppingRestricted && openWishlist && (
